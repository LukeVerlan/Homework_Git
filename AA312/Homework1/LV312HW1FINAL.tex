...
\begin{enumerate}
    ...
    Hence
    \[ \Longrightarrow \Delta w_n = \sqrt{\frac{3(6.9 * 10^9 \left[\frac{N}{m^2}\right])(5.2*10^{-5}\left[m^4\right])}{(2 \left[m\right])^3}}\left(\frac{1}{\sqrt{20 \left[kg\right]}} - \frac{1}{\sqrt{2000 \left[kg \right]}}\right) = 73.82 \left[\frac{rad}{s}\right] \] 
    Or $11.74 \left[Hz\right]$. Other engineers working on this aircraft need to be aware of this as to not contstruct a system that has a resonant frequency between the range of the natural frequencies the wing has throughout the flight. Doing this could lead to uncontrollable vibrations due to said resonance in the given system
